...
class UIGestureDetector extends GestureDetector with ExtraHitTestBase {
  UIGestureDetector({
    Key? key,
    Widget? child,
  ...
  Widget build(BuildContext context) {
    ...
    return RawGestureDetectorHitTestWithoutSizeLimit(
      ...
      debugHitTestAreaColor: MeteorUI.of(context).debugHitTestAreaColor ?? debugHitTestAreaColor,
    );
  }
}
